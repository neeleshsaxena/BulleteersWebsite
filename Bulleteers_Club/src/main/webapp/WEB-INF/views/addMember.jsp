 ...
 <div class="brand">Bulleteers Club</div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                <h3 class="brand-name text-center">Earn Your Patch</h3>
                        <h5 class="intro-text text-center">Please fill out each section completely</h5>
                </div>        
            </div>           
        </div>    

        <form:form class="form-login" method="POST" action="addMemberDetails" commandname="member">
        <div class="row">
            <div class="greenbox">
                    <div class="col-12-lg">
            ...
            <div class ="box">
                <div class ="col-lg-12">
                    <h4 class="intro-text text-left">
								...
								<div class="form-group">
                                    <label for ="motorcycle">Motorcycle You Own</label>
                                    <input id="bike" class="form-control" name="bike" type="text" required>
                                </div>
						<div class="form-group">
						<label for ="clubs">Choose Your Club :</label>
						<select class="form-control" name="club">
						<c:forEach var ="club" items="${sessionScope.list}" >
						
						
							<option><c:out value="${club }"></c:out></option>
						</c:forEach>	
						</select>
						...
						<div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  placeholder="Enter Apt" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  placeholder="Enter Zip" required>
                                </div> 
                              ...
                              " class="btn btn-success" type="submit">Earn Your Patch</button>
                </div>    
            </div>    
        </div> 
	</form:form>     
